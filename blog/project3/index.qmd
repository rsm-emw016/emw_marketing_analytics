...
Next, we examine the pairwise correlations between numeric variables using a heatmap. This helps identify which features are most linearly related to each other, and can also help diagnose multicollinearity before modeling.
